...
const Reservation = () => {
  ...
  const [auth, setAuth] = useState(state.register)
  ...
  return (
    <>
      ...
      {auth && result !== null && isModalError && <Modal click={setIsModalError}>
      ...
      {auth && result !== null && isModalSuccess && <Modal click={setIsModalSuccess} >
